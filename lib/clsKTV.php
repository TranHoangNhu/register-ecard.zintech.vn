...
class clsKTV {
	...
	{	
		...
		try
		{
			$rs_1 = $this->conn->query($sql_1);//sqlsrv_query($this->conn, $sql_1);
	...
	public function getAllKTV()
	{
		...
		$sql="with t1 as ( select 
				...
				GhiChuNV, SourceHinhAnh, HinhAnhTemp, GhiChuDichVu, ThuTuDieuTour, c.GioBatDau, c.GioKetThuc, c.GhiChu, d.MaPhieuDieuTour, d.MaBanPhong, d.TenHangBan, d.GioThucHien, e.SoLanPhucVu, e.SoSaoDuocYeuCau   
