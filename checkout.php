...
if(isset($_SESSION['MaKhachHang']))
    ...
    if(isset($_SESSION['MaTheVip']))
      unset($_SESSION['MaTheVip']);
    if(isset($_SESSION['LoaiTheVip']))
      unset($_SESSION['LoaiTheVip']);
    if(isset($_SESSION['NgayHetHan']))
      unset($_SESSION['NgayHetHan']);
    if(isset($_SESSION['LaTheDV']))
      unset($_SESSION['LaTheDV']);
    if(isset($_SESSION['LaTheGT']))
      unset($_SESSION['LaTheGT']);
    if(isset($_SESSION['SoDuTheVip']))
      unset($_SESSION['SoDuTheVip']);
?> 
  <script> 
    setTimeout('window.location="home.php"',0);
  </script>
	    ...
	    <div class='row' style='padding-top:25px; padding-bottom:25px;'>
	        <div class='col-xs-12 col-xs-12 col-md-6 col-md-offset-3'>
	            <div id='mainContentWrapper'>
	               		<div class="btn btn-info" style="width : 100%;"><h2 style="text-align: left;"><a href="checkout.php" style="color:#fff"><i class="fa fa-arrow-left"></i></a> Thanh Toán</h2></div>
	                    <hr/>
	                        ...
	                        <div class="panel panel-default">
	                            <div class="panel-heading">
	                                <h4 class="panel-title">
	                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Chi tiết: <?php echo $loithanhtoan; ?></a>
	                                </h4>
	                            ...
	                            <div id="collapseOne" class="panel-collapse collapse in">
                                 ...
                                 <label class="radio-inline">
                                  <input type="radio" name="optradio" value="theghino">Thẻ ghi nợ
                                </label>
														  </form>
