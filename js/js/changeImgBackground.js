...
function changeBgImgHandler(idClick) {
  const beforeBgStyle = document.querySelector(".ecard-before img");
  const afterBgStyle = document.querySelector(".ecard-after").style;
  beforeBgStyle.src = `images/background_truoc_${idClick}.png`;
  // beforeBgStyle.backgroundSize = "cover";
  // beforeBgStyle.backgroundPosition = "center center";
  afterBgStyle.backgroundImage = `url('images/background_sau_${idClick}.png')`;
